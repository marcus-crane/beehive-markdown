---
title: "Government launches Toolkits for District Health Boards"
date: 2001-10-31
url: https://www.beehive.govt.nz/release/government-launches-toolkits-district-health-boards-0
ministers:
  - Annette King
portfolios:
  - Health
...
Health Minister Annette King today launched a set of Toolkits to help District Health Boards meet the 13 priority health objectives of the New Zealand Health Strategy.
...
For this reason they all take a slightly different approach, which is based on the advice of the expert groups. For example:  
„h The Cardiovascular Toolkit looks at the major risk factors and then categories of cardiovascular disease, such as heart failure and stroke, and gives information on available tools that DHBs can use such as guidelines, information packs, videos etc.  
„h The Suicide Toolkit looks at risk factors and then adopts a thematic approach looking at issues such as mental health promotion, training on suicide risk assessment, and reducing access to the means of suicide.  
„h The Nutrition Toolkit identifies the best evidence on interventions to improve nutrition and also provides a checklist for DHBs.
